...
inline const char *EnumNameStatus(Status e) {
  if (e < Status::IDLE || e > Status::FAILURE) return "";
...
inline const char *EnumNameType(Type e) {
  if (e < Type::UNDEFINED || e > Type::SUBTREE) return "";
  const size_t index = static_cast<int>(e);
...
struct PortConfigBuilder {
  ...
  void add_value(flatbuffers::Offset<flatbuffers::String> value) {
    fbb_.AddOffset(PortConfig::VT_VALUE, value);
  }
...
inline flatbuffers::Offset<PortConfig> CreatePortConfigDirect(
  ...
  return BT_Serialization::CreatePortConfig(
      _fbb,
      port_name__,
      value__);
}
...
struct TreeNode FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<PortConfig>> *ports() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<PortConfig>> *>(VT_PORTS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct TreeNodeBuilder {
  ...
  void add_ports(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<PortConfig>>> ports) {
    fbb_.AddOffset(TreeNode::VT_PORTS, ports);
  }
...
inline flatbuffers::Offset<TreeNode> CreateTreeNode(
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<PortConfig>>> ports = 0) {
...
inline flatbuffers::Offset<TreeNode> CreateTreeNodeDirect(
    ...
    const std::vector<flatbuffers::Offset<PortConfig>> *ports = nullptr) {
  ...
  auto ports__ = ports ? _fbb.CreateVector<flatbuffers::Offset<PortConfig>>(*ports) : 0;
