...
def convert_stream(in_stream: typing.TextIO, out_stream: typing.TextIO):
    ...
    element_tree.write(out_stream, encoding="unicode")
...
def main():
    ...
    parser.add_argument(
        ...
        help="The file to convert from. If absent, reads xml string from stdin.",
    )
    parser.add_argument(
        "-o",
        "--out_file",
        ...
        default=sys.stdout,
        help="The file to write the converted xml."
